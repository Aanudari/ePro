...
function MobileBar() {
    ...
    return ( 
        <div style={{background: "rgba(0,0,0,0.4)"}} className='fixed w-screen h-screen top-0 left-0'>
            <div className="w-[250px] h-full top-0 left-0 bg-white shadow-cus content fixed expanded-menu">
            <div className="h-full w-[250px] fixed pl-4 pt-4 pr-4 md:overflow-hidden overflow-auto md:hover:overflow-auto cus-index">
                <div className="w-full flex justify-between mb-3">

                    <img onClick={() => { navigate("/home"); setMobileBar(false) }} alt="ДДЭШТВ ХХК" className="w-[120px] ml-1 hover:scale-105 transition" src="./ddish_logo.png" />
                    <button onClick={() => {
                ...
                <div>
                    ...
                    {
                        roleId === "199" ?
                            <div onClick={() => { setMobileBar(false); navigate("/exam-form"); }} className={path == "/exam-form" ?
                    ...
                    <div
                        onClick={() => {
                            setMobileBar(false); navigate("/take-exam");
                        }}
                        className={
                            path == "/take-exam" ?
                                "w-full h-12 cursor-pointer pl-4 flex items-center rounded-md bg-sky-500 text-white font-bold" :
                    ...
                    <div
                        onClick={() => {
                            setMobileBar(false); navigate("/exam-result");
                        }}
                        className={
                            path == "/exam-result" ?
                                "w-full h-12 cursor-pointer pl-4 flex items-center rounded-md bg-sky-500 text-white font-bold" :
                ...
                <div>
                    ...
                    <div
                        onClick={() => {
                            setMobileBar(false); navigate("/dashboard");
                        }}
                        className={
                            path == "/dashboard" ?
                                "w-full h-12 cursor-pointer pl-4 flex items-center rounded-md bg-sky-500 text-white font-bold" :
                    ...
                    <div
                        onClick={() => {
                            setMobileBar(false); navigate("/level-one");
                        }}
                        className={
                            path == "/level-one" ?
                                "w-full h-12 cursor-pointer pl-4 flex items-center rounded-md bg-sky-500 text-white font-bold" :
                    ...
                    <div
                        onClick={() => {
                            setMobileBar(false); navigate("/complain");
                        }}
                        className={
                            path == "/complain" ?
                                "w-full h-12 cursor-pointer pl-4 flex items-center rounded-md bg-sky-500 text-white font-bold" :
                    ...
                    <div
                        onClick={() => {
                            setMobileBar(false); navigate("/telesales");
                        }}
                        className={
                            path == "/telesales" ?
                                "w-full h-12 cursor-pointer pl-4 flex items-center rounded-md bg-sky-500 text-white font-bold" :
                    ...
                    <div
                        onClick={() => {
                            setMobileBar(false); navigate("/online");
                        }}
                        className={
                            path == "/online" ?
                                "w-full h-12 cursor-pointer pl-4 flex items-center rounded-md bg-sky-500 text-white font-bold" :
                    ...
                    <div
                        onClick={() => {
                            setMobileBar(false); navigate("/branch");
                        }}
                        className={
                            path == "/branch" ?
                                "w-full h-12 cursor-pointer pl-4 flex items-center rounded-md bg-sky-500 text-white font-bold" :
                    ...
                    <div
                        onClick={() => {
                            setMobileBar(false); navigate("/installer");
                        }}
                        className={
                            path == "/installer" ?
                                "w-full h-12 cursor-pointer pl-4 flex items-center rounded-md bg-sky-500 text-white font-bold" :
                    ...
                    <div
                        onClick={() => {
                            setMobileBar(false); navigate("/care");
                        }}
                        className={
                            path == "/care" ?
                                "w-full h-12 cursor-pointer pl-4 flex items-center rounded-md bg-sky-500 text-white font-bold" :
                    ...
                    <div
                        onClick={() => {
                            setMobileBar(false); navigate("/bank");
                        }}
                        className={
                            path == "/bank" ?
                                "w-full h-12 cursor-pointer pl-4 flex items-center rounded-md bg-sky-500 text-white font-bold" :
                ...
                <div>
                    ...
                    <div
                        onClick={() => {
                            setMobileBar(false); navigate("/calendar");
                        }}
                        className={
                            path == "/dashboard" ?
                                "w-full h-12 cursor-pointer pl-4 flex items-center rounded-md bg-sky-500 text-white font-bold" :
                    ...
                    <div
                        onClick={() => {
                            setMobileBar(false); navigate("/create-training");
                        }}
                        className={
                    ...
                    <div
                        onClick={() => {
                            setMobileBar(false); navigate("/took-training");
                        }}
                        className={
                            path == "/took-training" ?
                                "w-full h-12 cursor-pointer pl-4 flex items-center rounded-md bg-sky-500 text-white font-bold" :
                    ...
                    <div
                        onClick={() => {
                            setMobileBar(false); navigate("/trainings");
                        }}
                        className={
                            path == "/trainings" ?
                                "w-full h-12 cursor-pointer pl-4 flex items-center rounded-md bg-sky-500 text-white font-bold" :

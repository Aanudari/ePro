  ...
  return (
      <div className="w-[375px] relative h-full shadow-cus content">
        <div className="h-full w-[280px] fixed pl-4 pt-4 pr-4 md:overflow-hidden overflow-auto md:hover:overflow-auto">
                ...
                <div
                    ...
                    className={
                        path == "/create-training" ?
                            "w-full h-10 cursor-pointer pl-2 flex items-center rounded-md bg-sky-500 text-white font-bold" :
                            "w-full h-10 cursor-pointer pl-2 hover:bg-gray-100 flex items-center rounded-md "
                    }
                >
            ...
            <div className="card border-primary mb-3">
                <div className="card-body text-primary">
                    <h6 className="card-title">© 2020 DDISHTV LLC</h6>

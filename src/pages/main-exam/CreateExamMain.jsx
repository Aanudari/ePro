...
function CreateExamMain({checked, depId, setCategoryModal, setShowCategoryMenu, setTriggerCat, triggerCat}) {
    ...
    const [pointStatus, setPointStatus] = useState({ value: '', label: 'Ажилтан сонгох' });
    return (
                ...
                <form className="form-form p-2 flex flex-col md:flex-row gap-5 w-full justify-around">
                    {
                        showQuestionMenu ?
                            ...
                            <div className="form-form flex gap-5 mt-4 w-full
                            ...
                            ">
                                ...
                                <div className="h-full w-full md:w-1/2 pr-0 flex flex-col justify-between">
                                    ...
                                    <div className="mt-2">
                                        <h6 className="text-gray-500/80 text-[17.5px] mt-[10px]">Хэлтэс :</h6>
                                        <OptionSelect handleSelect={handleSelect} optionss={optionss}/>
                                    </div>
                                    <div className="">
                                        <h6 className="text-gray-500/80 text-[17.5px] mt-3">Ажилтан :</h6>
                                        <PointSelect handleDeviceId={handleDeviceId} unit={unitData} setPointStatus={setPointStatus}/>
                                    </div>

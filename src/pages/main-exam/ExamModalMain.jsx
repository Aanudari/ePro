            ...
            <div className="shrink w-[calc(85%)] h-[600px] bg-white flex flex-col rounded-t-lg relative">
                ...
                </div>
                {
                    editHeader === false ?
                        ...
                        :
                        <ExamEditHeader examTri={examTri} setExamTri={setExamTri} setExamModal={setExamModal} array1={array1} chosen={chosen} setEditHeader={setEditHeader} editHeader={editHeader} />
                }
                    ...
                    <div className="h-full pt-2">
                        {
                            ...
                            data[0]?.questionList?.map((question, index) => (
                                ...
                                //  QUESTION !!!
                                //  QUESTION !!!
                                <div key={index} className={`mt-3 border-t-[5px] border-l border-r border-[#50a3a2] rounded-lg realtive `}>
                                    <div
                                        onClick={() => {
                                            checked.length < 1
                                                &&
                                                handleQuestion(question.id, question.question, question.points)
                                        }}
                                            ...
                                            }
                                            {
                                                checked.includes(question.id) ?
                                                    <div className="h-[42px]">
                                                        ...
                                                        }} defaultValue={question.points} type="text" className="outline-none mt-2 rounded-md ml-2 h-[40px] focus:border-b-[2px] focus:h-[42px] border-teal-500 px-2 text-[14px] w-1/2 font-[400]"
                                                            autoCorrect="false" spellCheck={false} />
                                                    ...
                                                    <div className="">
                                                        ...
                                                        <div className="w-full mt-4 flex justify-between">
                                                            <span onClick={addAnswer} className="text-teal-500 hover:text-teal-400 font-[500]">
                                                                ...
                                                                }} className="bi bi-trash3-fill text-red-500 text-xl font-[500] mr-3"></i>
                                                                <button
                                                                onClick={() => {
                    ...
                    <div className="px-2 py-2">
                        ...
                        }
                        {
                            ...
                            categoryData?.map((item, index) => (
                                <div  key={index}  className=" py-2 w-full border mb-1 flex items-center pl-3 justify-between shadow-sm cursor-pointer  ">

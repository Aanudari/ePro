    ...
    <div className="">
      <div className="h-[42px] mt-1 relative parent">
        ...
        <input
          ...
          type="text"
          className={`outline-none mt-2 rounded-md ml-2 h-[40px] 
        ...
        <i
          ...
          className="bi active:text-red-500 bi-trash3 absolute left-[calc(55%)] text-gray-600 child hidden top-[20px]"
        ></i>

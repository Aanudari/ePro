...
function Folder({ index, expandKey, setExpandKey, item, trigger, setTrigger }) {
  ...
  return (
    <div
      ...
      className="folder-cus-container"
    >
      <div className="folder" id="js_folder">
        ...
        >
          ...
          <div className="folder-summary__details">
            <div className="folder-summary__details__name">{item.month}</div>
            <div className="folder-summary__details__share">Design by</div>
          </div>
        ...
        <ul
          className="folder-content !mb-0 overflow-scroll p-0"
        ...
        >
          {item.ratings.map((rating, index) => {
            return (
              // <li
              //   key={index}
              //   className="folder-item js_folder-item hover:bg-gray-100 cursor-pointer"
              // >
              ...
              //     <div className="folder-item__size">
              //       {rating.adminInfo.ratedUser}/{rating.adminInfo.totalUser}
              //     </div>
              //     <div className="text-[13px] text-[#BEBDBF] mt-[10px]">
              //       {rating.adminInfo.avgScore == ""
              //         ? 0
              //         : rating.adminInfo.avgScore}
              //       %
              //     </div>
              ...
              <RatingBlock
                item={rating}
                key={JSON.stringify(rating + index)}
                trigger={trigger}

...
function RatingHeader({ setSideMenu, sideMenu }) {
  const { ratingDate2, setRatingDate2, ratingDate, setRatingDate } =
    useStateContext();

  return (
    <div
      className="w-full h-14 bg-gray-100 border-b-[2px] border-gray-300 shadow-sm flex justify-between
        items-center px-10"
    >
      <div className="!flex h-full items-center ">
        <div className="!flex h-full items-center ">
          <DatePicker
            selected={ratingDate}
            value={ratingDate}
            onChange={(date) => setRatingDate(date)}
          ...
          />
          <DatePicker
            selected={ratingDate2}
            value={ratingDate2}
            onChange={(date) => setRatingDate2(date)}
            className="form-control form-control-sm
        ...
        >
          <span className="mr-2 mb-1 font-[400] text-white">Тайлан</span>
      ...
      >
        <span className="mr-2 mb-1 font-[400] text-white">Үнэлгээ үүсгэх</span>
        <div className="pl-2 h-full flex items-center border-l border-gray-300">

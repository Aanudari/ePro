      ...
      {!addCategory ? (
          ...
          <div className="w-full h-12 bg-teal-500 rounded-t flex justify-between px-4 items-center">
            ...
            <div>
              <i
                ...
                className="bi bi-trash3 text-xl cursor-pointer hover:scale-105 mr-5 "
              ></i>
              <i
                onClick={() => {
                  setShowModal(false);
                  ...
                  <div className=" flex justify-between px-4 py-2 relative">
                    <div className="">
                      <i
                        ...
                        className="bi bi-trash3-fill text-white mr-2 text-sm"
                      ></i>
                      <span className="text-white font-[500] text-sm">
                        Нэр: {item.name}
                      </span>
        ...
        <div className="bg-white appear-smooth w-10/12 h-[calc(70%)] rounded-t">
          ...
          <div
            ...
            className="bg-teal-500 w-full h-12 flex justify-center items-center font-[400]
                        text-white cursor-pointer hover:bg-teal-600 active:bg-teal-400"
          >
            Үүсгэх
          </div>
        </div>
